...
export const valueProps = [
  {
    ...
    description:
      "面对几十个学校和项目，最难的往往不是「选哪个」，而是「从哪些角度选」。Creator 为你建立清晰的判断维度——学术声誉、就业数据、项目匹配度、地理偏好、经济考量——让你在信息海洋中建立自己的评估体系。",
    icon: "🔍",
  },
  {
    id: "plan",
    ...
    description:
      "「我要申请研究生」是一个模糊的愿望，不是一个可执行的任务。Creator 把它拆成：第1周锁定方向、第2-3周扫描条件、第1-2个月背景提升、第3-4个月材料准备——每个阶段有明确产出和检查点。",
    icon: "📋",
  },
  {
    id: "trust",
    ...
    description:
      "在关键的升学和求职决策中，「感觉」和「听说」不够。Creator 的回答基于判断框架和规划方法论，提供可追溯的参考来源，让你在做决定时有底，而不是靠猜测。",
    icon: "🛡️",
  },
];
...
// Features comparison (why Creator vs general ChatGPT)
export const comparisonData = [
  {
    dimension: "回答结构",
    generic: "自由对话，可能散乱",
    creator: "固定模板：结论 → 维度 → 计划 → 下一步",
  },
  {
    dimension: "领域深度",
    generic: "通用知识，缺乏升学/求职专项",
    creator: "专注升学与就业场景，系统提示词定向优化",
  },
  {
    dimension: "可执行性",
    generic: "建议偏宏观，缺少具体步骤",
    creator: "按周拆解任务，每个阶段有明确产出",
  },
  {
    dimension: "上下文管理",
    generic: "可能混淆不同场景的对话",
    creator: "升学/就业双模式隔离，切换清空上下文",
  },
  {
    dimension: "展示方式",
    generic: "纯聊天界面",
    creator: "工作台式布局：模式切换 + 快捷入口 + 参考来源",
  },
];
...
export const faqData = [
  {
    question: "Creator 和通用 ChatGPT 有什么不同？",
    answer:
      "Creator 是一个专门为升学和就业规划设计的 AI 工作台。它有两个核心差异：第一，系统提示词是定向优化的——AI 被训练以「结论先行 → 判断维度 → 执行计划 → 下一步」的结构化模板回答；第二，它提供工作台式的操作界面——模式切换、快捷问题、参考来源、行动建议等，不是简单的聊天框。",
  },
  {
    question: "需要注册或付费吗？",
    answer:
  ...
  },
  {
    ...
    answer:
      "Creator 的系统提示词明确要求 AI 不编造用户背景、不给高风险建议（医疗、法律、金融等）。AI 的回答基于其训练数据中的教育规划知识，但涉及具体的院校录取数据、岗位薪资等时效性信息时，建议交叉验证官方来源。每个回答页面都会展示可信参考来源。",
  },
  {
    question: "适合什么样的学生使用？",
    answer:
      "Creator 面向正在准备研究生申请的大学生、正在找实习和校招的应届生、以及需要规划职业路径的初级职场人。无论你是大二还没开始准备、还是大四正在冲刺申请，都可以通过明确你的当前阶段来获得针对性的规划建议。",
  },
  {
